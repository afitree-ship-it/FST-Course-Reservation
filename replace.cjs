...
const oldBlock = `    // ลบ link rel="icon" หรือ rel="shortcut icon" ที่มีอยู่ทั้งหมดเพื่อล้างของเก่าออกทั้งหมด
...
const newBlock = `    const activeFavicon = customFavicon || customLogo;
