...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  th: {
    ...
    statusInputPlaceholder: 'รหัสนักศึกษา 9 หลัก (เช่น 650109121)',
    ...
    adminLoginPassPlaceholder: 'ป้อนรหัสผ่าน (ค่าดีฟอลต์สำหรับทดสอบคือ 1234 หรือ admin)',
  ...
  en: {
    ...
    adminLoginPassPlaceholder: 'Key code (Developer default: 1234 or admin)',
